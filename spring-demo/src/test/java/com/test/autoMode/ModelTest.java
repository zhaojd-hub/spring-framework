...
public class ModelTest {
	...
	/**
	 * 测试@Autowired的注入基本原理 先type继而name 如果有多个再name
	 */
	@Test
	...
	/**
	 * 测试@Order注解的功能 不会影响bean的扫描顺序 具体需要看spring源码内部有没有对他做解析
	 */
	@Test
	...
	/**
	 * 测试工厂方法实例工厂方法、supplier spring优先选用supplier
	 */
	@Test
